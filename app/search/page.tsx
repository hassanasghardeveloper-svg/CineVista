...
function transformSearchResult(result: SearchResult): Movie {
    return {
        ...
        title: result.name,
        overview: '',
        posterPath: result.image_url || 'https://via.placeholder.com/500x750?text=No+Poster',
        backdropPath: result.image_url || '',
            ...
            try {
                ...
                if (data.titles) {
                    setPopularMovies(data.titles.map((m: any) => ({
                        ...
                        posterPath: m.poster || 'https://via.placeholder.com/500x750?text=No+Poster',
