            ...
            <div className="pt-32 pb-20 px-6 md:px-12 max-w-[1600px] mx-auto">
                <div className="mb-8">
                    ...
                    <div className="flex flex-wrap gap-3 mt-8 mb-8">
                        {(['trending', 'popular', 'top_rated', 'pakistani', 'indian', 'turkish', 'animation'] as Category[]).map(tab => (
                            <button
                                key={tab}
                            ...
                            >
                                {tab === 'top_rated' ? 'Top Rated' : tab === 'pakistani' ? '🇵🇰 Pakistani' : tab === 'indian' ? '🇮🇳 Bollywood' : tab === 'turkish' ? '🇹🇷 Turkish' : tab}
                            </button>
                        ))}
                    </div>
